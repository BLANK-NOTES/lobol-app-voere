...
// infoExpanded is declared once in data.js (shared global state).
// Re-declaring it here with `let` threw a SyntaxError in the browser
// and broke this whole file.
...
// App bootstrap is centralized in index.html (runs once after all
// modules load). Do not initialize here — doing so booted the app
// twice and created duplicate refresh timers.