...
// Note: toggleAssign() and markDone() are defined in workers.js
// (the duties page uses its own toggleAssignFromModal instead).
// The duplicate copies that used to live here were removed.